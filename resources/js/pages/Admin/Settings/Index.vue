      ...
      <div class="border-b border-border mb-6">
        <div class="flex space-x-4">
          <button 
            ...
            class="py-2 px-4 border-b-2 transition-colors focus:outline-none"
            :class="activeTab === 'general' ? 'border-primary font-medium text-primary' : 'border-transparent hover:border-muted-foreground/30'"
          >
          ...
          <button 
            ...
            class="py-2 px-4 border-b-2 transition-colors focus:outline-none"
            :class="activeTab === 'media' ? 'border-primary font-medium text-primary' : 'border-transparent hover:border-muted-foreground/30'"
          >
            <div class="flex items-center gap-2">
          ...
          <button 
            ...
            class="py-2 px-4 border-b-2 transition-colors focus:outline-none"
            :class="activeTab === 'scripts' ? 'border-primary font-medium text-primary' : 'border-transparent hover:border-muted-foreground/30'"
          >
            <div class="flex items-center gap-2">
